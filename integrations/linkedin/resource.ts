export const resource = {
  userClientId: Bun.env.LINKEDIN_USER_CLIENT_ID!,
  userClientSecret: Bun.env.LINKEDIN_USER_CLIENT_SECRET!,
  userAccessToken: Bun.env.LINKEDIN_USER_ACCESS_TOKEN!,
  organizationClientId: Bun.env.LINKEDIN_ORGANIZATION_CLIENT_ID!,
