// NOTE: Requires Community Management API access, refer README.md file..

// import { expect, test } from "bun:test";
// import { main } from "./script.bun.ts";
// import { resource } from "../resource.ts";

// test("Gets Organization Access Control", async () => {
//   // script arguments here (also load environment variables if needed using Bun.env.VARIABLE_NAME!)

//   console.log("TEST: Will test Gets Organization Access Control with arguments: " /* arguments */)
